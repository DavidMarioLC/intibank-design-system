...
- **THEN** focused Button stories and TextField default, optional, adorned, helper, invalid, disabled, read-only, focus, and interaction stories are present
...
- **THEN** the temporary application installs the tarball, imports Button, TextField, and CSS, and builds them successfully without Tailwind
