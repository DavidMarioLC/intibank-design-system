...
- **THEN** focused Button, TextField, and MoneyField stories cover their documented variants, states, formatting, focus, and interactions
...
- **THEN** the temporary application installs the tarball, imports Button, TextField, MoneyField, and CSS, and builds them successfully without Tailwind
