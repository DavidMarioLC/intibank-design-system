...
- **THEN** focused Avatar, Button, TextField, and MoneyField stories cover their documented variants, states, formatting, focus, and interactions
...
- **THEN** the temporary application installs the tarball, imports Avatar, Button, TextField, MoneyField, and CSS, and builds them successfully without Tailwind
