...
- 282339d: Agrega el componente `Tabs`, sobre `@base-ui/react/tabs`: `Tabs.Root`, `Tabs.List`, `Tabs.Tab`, `Tabs.Indicator` y `Tabs.Panel`.
...
- 2fa1301: Suma `Table`, la lista tabular de movimientos.
